...
@section('content')
    ...
    <div class="d-flex flex-row mb-3">
        <a href="{{ route('admin.blog.categories.edit', $category) }}" class="btn btn-primary mr-1">Edit</a>
        ...
        <tr>
            <th>Parent</th><td>
                @if(isset($category->parent))
                    <a href="{{ route('admin.blog.categories.show', $parentCategory) }}">{{ $category->parent->name }}</a>
                @else
                    Empty
                @endif
            </td>
